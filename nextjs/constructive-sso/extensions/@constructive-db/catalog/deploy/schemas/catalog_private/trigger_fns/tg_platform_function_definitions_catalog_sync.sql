-- Deploy: schemas/catalog_private/trigger_fns/tg_platform_function_definitions_catalog_sync
-- made with <3 @ constructive.io

-- requires: schemas/catalog_private/schema


CREATE FUNCTION catalog_private.tg_platform_function_definitions_catalog_sync() RETURNS trigger AS $$BEGIN
