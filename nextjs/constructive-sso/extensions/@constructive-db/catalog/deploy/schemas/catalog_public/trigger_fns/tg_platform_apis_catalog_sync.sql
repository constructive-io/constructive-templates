-- Deploy: schemas/catalog_public/trigger_fns/tg_platform_apis_catalog_sync
-- made with <3 @ constructive.io

-- requires: schemas/catalog_public/schema


CREATE FUNCTION catalog_public.tg_platform_apis_catalog_sync() RETURNS trigger AS $$BEGIN
