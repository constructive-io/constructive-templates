-- Deploy: schemas/myapp_user_identifiers_private/tables/connected_accounts/policies/auth_upd_dir_own/policy
...
CREATE POLICY auth_upd_dir_own ON myapp_user_identifiers_private.connected_accounts
FOR UPDATE
TO authenticated
USING (
