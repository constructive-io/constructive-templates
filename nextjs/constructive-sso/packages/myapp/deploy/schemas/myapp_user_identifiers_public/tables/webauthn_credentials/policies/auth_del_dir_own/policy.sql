-- Deploy: schemas/myapp_user_identifiers_public/tables/webauthn_credentials/policies/auth_del_dir_own/policy
...
CREATE POLICY auth_del_dir_own ON myapp_user_identifiers_public.webauthn_credentials
FOR DELETE
TO authenticated
USING (
