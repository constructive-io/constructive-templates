-- Deploy: schemas/myapp_auth_private/tables/auth_user_devices/policies/auth_del_dir_own/policy
...
CREATE POLICY auth_del_dir_own ON myapp_auth_private.auth_user_devices
FOR DELETE
TO authenticated
USING (
