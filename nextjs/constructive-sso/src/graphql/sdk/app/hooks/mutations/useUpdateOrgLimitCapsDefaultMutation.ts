 ...
 * @example
 * ```tsx
 * const { mutate, isPending } = useUpdateOrgLimitCapsDefaultMutation({
 *   selection: { fields: { id: true, name: true } },
 * });
 *
 * mutate({ id: 'value-here', orgLimitCapsDefaultPatch: { name: 'Updated' } });
 * ```
 */
export function useUpdateOrgLimitCapsDefaultMutation<S extends OrgLimitCapsDefaultSelect>(
  params: {
    selection: {
...
>;
export function useUpdateOrgLimitCapsDefaultMutation(
  params: {
  ...
  return useMutation({
    ...
    mutationFn: ({
      ...
      getClient()
        .orgLimitCapsDefault.update({
          where: {
            id,
          },
          data: orgLimitCapsDefaultPatch,
          select: args.select,
        })
        .unwrap(),
