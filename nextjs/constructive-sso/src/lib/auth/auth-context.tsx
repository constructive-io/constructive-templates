...
import { executeAuth } from '@/graphql';
 ...
 * auth (trySessionAuth) to hydrate from an OAuth callback.
 */
async function initializeAuth(
	...
	if (!token) {
		// No localStorage token — try cookie-based session auth
		await trySessionAuth(authActions);
		return;
	}
