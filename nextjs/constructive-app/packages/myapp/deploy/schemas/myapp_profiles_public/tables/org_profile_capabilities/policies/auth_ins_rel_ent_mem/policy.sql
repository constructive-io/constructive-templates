-- Deploy: schemas/myapp_profiles_public/tables/org_profile_capabilities/policies/auth_ins_rel_ent_mem/policy
...
CREATE POLICY auth_ins_rel_ent_mem ON myapp_profiles_public.org_profile_capabilities
FOR INSERT
TO authenticated
WITH CHECK (
