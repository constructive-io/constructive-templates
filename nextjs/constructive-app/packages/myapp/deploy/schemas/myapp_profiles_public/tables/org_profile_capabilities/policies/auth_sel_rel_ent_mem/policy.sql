-- Deploy: schemas/myapp_profiles_public/tables/org_profile_capabilities/policies/auth_sel_rel_ent_mem/policy
...
CREATE POLICY auth_sel_rel_ent_mem ON myapp_profiles_public.org_profile_capabilities
FOR SELECT
TO authenticated
USING (
