-- Deploy: schemas/myapp_profiles_public/tables/app_profile_capabilities/policies/auth_ins_app_mem/policy
...
CREATE POLICY auth_ins_app_mem ON myapp_profiles_public.app_profile_capabilities
FOR INSERT
TO authenticated
WITH CHECK (
  EXISTS (SELECT 1
