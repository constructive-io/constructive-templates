-- Deploy: schemas/myapp_profiles_public/tables/app_profile_capabilities/policies/auth_upd_app_mem/policy
...
CREATE POLICY auth_upd_app_mem ON myapp_profiles_public.app_profile_capabilities
FOR UPDATE
TO authenticated
USING (
  EXISTS (SELECT 1
