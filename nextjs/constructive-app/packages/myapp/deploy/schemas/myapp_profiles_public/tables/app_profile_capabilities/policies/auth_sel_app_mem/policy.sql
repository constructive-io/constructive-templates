-- Deploy: schemas/myapp_profiles_public/tables/app_profile_capabilities/policies/auth_sel_app_mem/policy
...
CREATE POLICY auth_sel_app_mem ON myapp_profiles_public.app_profile_capabilities
FOR SELECT
TO authenticated
USING (
  EXISTS (SELECT 1
