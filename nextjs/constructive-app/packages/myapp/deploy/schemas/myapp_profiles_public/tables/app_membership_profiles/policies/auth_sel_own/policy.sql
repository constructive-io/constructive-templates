-- Deploy: schemas/myapp_profiles_public/tables/app_membership_profiles/policies/auth_sel_own/policy
...
CREATE POLICY auth_sel_own ON myapp_profiles_public.app_membership_profiles
FOR SELECT
TO authenticated
USING (
