-- Deploy: schemas/myapp_user_identifiers_private/tables/connected_accounts/policies/auth_del_dir_own/policy
...
CREATE POLICY auth_del_dir_own ON myapp_user_identifiers_private.connected_accounts
FOR DELETE
TO authenticated
USING (
