-- Deploy: schemas/myapp_limits_private/trigger_fns/app_limit_credits_apply_tg_fn
...
CREATE FUNCTION myapp_limits_private.app_limit_credits_apply_tg_fn() RETURNS TRIGGER AS $_PGFN_$
DECLARE
  v_limit_name text;
BEGIN
  SELECT name
