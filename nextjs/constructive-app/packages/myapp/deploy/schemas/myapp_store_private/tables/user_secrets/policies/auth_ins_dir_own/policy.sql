-- Deploy: schemas/myapp_store_private/tables/user_secrets/policies/auth_ins_dir_own/policy
...
CREATE POLICY auth_ins_dir_own ON myapp_store_private.user_secrets
FOR INSERT
TO authenticated
WITH CHECK (
