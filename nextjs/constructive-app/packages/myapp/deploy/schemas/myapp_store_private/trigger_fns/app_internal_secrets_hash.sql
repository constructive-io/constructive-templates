-- Deploy: schemas/myapp_store_private/trigger_fns/app_internal_secrets_hash
-- made with <3 @ constructive.io

-- requires: schemas/myapp_store_private/schema


CREATE FUNCTION myapp_store_private.app_internal_secrets_hash() RETURNS TRIGGER AS $_PGFN_$
BEGIN
