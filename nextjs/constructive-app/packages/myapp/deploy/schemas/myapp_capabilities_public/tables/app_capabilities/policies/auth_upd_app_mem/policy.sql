-- Deploy: schemas/myapp_capabilities_public/tables/app_capabilities/policies/auth_upd_app_mem/policy
...
CREATE POLICY auth_upd_app_mem ON myapp_capabilities_public.app_capabilities
FOR UPDATE
TO authenticated
USING (
  EXISTS (SELECT 1
