-- Deploy: schemas/myapp_capabilities_public/tables/org_capabilities/policies/auth_del_app_mem/policy
...
CREATE POLICY auth_del_app_mem ON myapp_capabilities_public.org_capabilities
FOR DELETE
TO authenticated
USING (
  EXISTS (SELECT 1
