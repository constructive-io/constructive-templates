-- Deploy: schemas/myapp_capabilities_public/tables/org_capability_defaults/policies/auth_sel_ent_mem/policy
...
CREATE POLICY auth_sel_ent_mem ON myapp_capabilities_public.org_capability_defaults
FOR SELECT
TO authenticated
USING (
