-- Deploy: schemas/myapp_capabilities_public/tables/org_capabilities/policies/auth_ins_app_mem/policy
...
CREATE POLICY auth_ins_app_mem ON myapp_capabilities_public.org_capabilities
FOR INSERT
TO authenticated
WITH CHECK (
  EXISTS (SELECT 1
