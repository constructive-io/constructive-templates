-- Deploy: schemas/myapp_capabilities_public/tables/org_capabilities/policies/auth_sel_all_all/policy
...
CREATE POLICY auth_sel_all_all ON myapp_capabilities_public.org_capabilities
FOR SELECT
TO authenticated
USING (
  TRUE
