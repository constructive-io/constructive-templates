-- Deploy: schemas/myapp_capabilities_public/tables/org_capability_defaults/policies/auth_del_ent_mem/policy
...
CREATE POLICY auth_del_ent_mem ON myapp_capabilities_public.org_capability_defaults
FOR DELETE
TO authenticated
USING (
