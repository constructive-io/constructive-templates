-- Deploy: schemas/myapp_capabilities_public/tables/app_capability_defaults/policies/auth_ins_app_mem/policy
...
CREATE POLICY auth_ins_app_mem ON myapp_capabilities_public.app_capability_defaults
FOR INSERT
TO authenticated
WITH CHECK (
  EXISTS (SELECT 1
