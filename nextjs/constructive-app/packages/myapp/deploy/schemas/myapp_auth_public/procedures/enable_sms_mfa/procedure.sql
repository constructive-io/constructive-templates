-- Deploy: schemas/myapp_auth_public/procedures/enable_sms_mfa/procedure
...
CREATE FUNCTION myapp_auth_public.enable_sms_mfa() RETURNS boolean AS $_PGFN_$
DECLARE
  v_user_id uuid;
BEGIN
  ...
  sms_mfa_enabled = true, mfa_enrolled_at = COALESCE(mfa_enrolled_at, CURRENT_TIMESTAMP)
  WHERE
    owner_id = v_user_id;
