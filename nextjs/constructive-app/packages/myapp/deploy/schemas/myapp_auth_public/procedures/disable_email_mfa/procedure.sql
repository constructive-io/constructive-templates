-- Deploy: schemas/myapp_auth_public/procedures/disable_email_mfa/procedure
...
CREATE FUNCTION myapp_auth_public.disable_email_mfa() RETURNS boolean AS $_PGFN_$
DECLARE
  v_user_id uuid;
BEGIN
  ...
  VALUES
    (v_user_id, 'disable_email_mfa', true);
  RETURN true;
END;
