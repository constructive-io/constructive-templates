-- Deploy: schemas/myapp_memberships_public/tables/app_admin_grants/policies/auth_ins_app_mem/policy
...
CREATE POLICY auth_ins_app_mem ON myapp_memberships_public.app_admin_grants
FOR INSERT
TO authenticated
WITH CHECK (
  EXISTS (SELECT 1
