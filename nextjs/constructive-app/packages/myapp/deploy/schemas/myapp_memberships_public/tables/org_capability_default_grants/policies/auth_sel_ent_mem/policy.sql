-- Deploy: schemas/myapp_memberships_public/tables/org_capability_default_grants/policies/auth_sel_ent_mem/policy
-- made with <3 @ constructive.io

-- requires: schemas/myapp_memberships_public/schema
-- requires: schemas/myapp_memberships_public/tables/org_capability_default_grants/table
-- requires: schemas/myapp_memberships_public/tables/org_capability_default_grants/policies/enable_row_level_security


CREATE POLICY auth_sel_ent_mem ON myapp_memberships_public.org_capability_default_grants
FOR SELECT
TO authenticated
USING (
