-- Deploy: schemas/myapp_memberships_public/tables/org_chart_edges/policies/auth_sel_ent_mem/policy
...
CREATE POLICY auth_sel_ent_mem ON myapp_memberships_public.org_chart_edges
FOR SELECT
TO authenticated
USING (
