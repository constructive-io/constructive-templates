-- Deploy: schemas/myapp_memberships_public/tables/org_capability_default_grants/policies/auth_ins_ent_mem/policy
...
CREATE POLICY auth_ins_ent_mem ON myapp_memberships_public.org_capability_default_grants
FOR INSERT
TO authenticated
WITH CHECK (
