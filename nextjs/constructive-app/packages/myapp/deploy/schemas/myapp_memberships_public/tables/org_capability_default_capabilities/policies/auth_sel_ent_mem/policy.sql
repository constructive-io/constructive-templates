-- Deploy: schemas/myapp_memberships_public/tables/org_capability_default_capabilities/policies/auth_sel_ent_mem/policy
...
CREATE POLICY auth_sel_ent_mem ON myapp_memberships_public.org_capability_default_capabilities
FOR SELECT
TO authenticated
USING (
