...
CREATE INDEX org_memberships_sprts_entity_id_idx ON myapp_memberships_private.org_memberships_sprt USING BTREE ( entity_id ) INCLUDE ( capabilities, is_owner, is_admin, is_read_only );
