-- Deploy: schemas/myapp_memberships_private/trigger_fns/org_grants_apply_tg
...
CREATE FUNCTION myapp_memberships_private.org_grants_apply_tg() RETURNS TRIGGER AS $_PGFN_$
BEGIN
