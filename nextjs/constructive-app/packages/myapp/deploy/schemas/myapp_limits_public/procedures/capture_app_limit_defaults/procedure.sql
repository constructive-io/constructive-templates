-- Deploy: schemas/myapp_limits_public/procedures/capture_app_limit_defaults/procedure
...
CREATE FUNCTION myapp_limits_public.capture_app_limit_defaults() RETURNS jsonb AS $_PGFN_$
BEGIN
  RETURN (SELECT
