-- Deploy: schemas/myapp_limits_public/tables/org_limit_credits/policies/auth_sel_ent_mem/policy
...
CREATE POLICY auth_sel_ent_mem ON myapp_limits_public.org_limit_credits
FOR SELECT
TO authenticated
USING (
