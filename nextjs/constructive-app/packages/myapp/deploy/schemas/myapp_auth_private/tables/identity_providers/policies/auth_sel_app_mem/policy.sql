-- Deploy: schemas/myapp_auth_private/tables/identity_providers/policies/auth_sel_app_mem/policy
...
CREATE POLICY auth_sel_app_mem ON myapp_auth_private.identity_providers
FOR SELECT
TO authenticated
USING (
  EXISTS (SELECT 1
