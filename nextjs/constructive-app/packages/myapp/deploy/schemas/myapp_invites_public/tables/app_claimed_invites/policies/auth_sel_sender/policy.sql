-- Deploy: schemas/myapp_invites_public/tables/app_claimed_invites/policies/auth_sel_sender/policy
...
CREATE POLICY auth_sel_sender ON myapp_invites_public.app_claimed_invites
FOR SELECT
TO authenticated
USING (
