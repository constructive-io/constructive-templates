-- Deploy: schemas/myapp_invites_public/tables/org_invites/policies/auth_del_dir_own/policy
...
CREATE POLICY auth_del_dir_own ON myapp_invites_public.org_invites
FOR DELETE
TO authenticated
USING (
