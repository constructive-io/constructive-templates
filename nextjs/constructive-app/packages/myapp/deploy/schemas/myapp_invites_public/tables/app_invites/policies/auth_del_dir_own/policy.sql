-- Deploy: schemas/myapp_invites_public/tables/app_invites/policies/auth_del_dir_own/policy
...
CREATE POLICY auth_del_dir_own ON myapp_invites_public.app_invites
FOR DELETE
TO authenticated
USING (
