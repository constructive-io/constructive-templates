-- Deploy: schemas/myapp_user_identifiers_public/tables/phone_numbers/policies/auth_ins_dir_own/policy
...
CREATE POLICY auth_ins_dir_own ON myapp_user_identifiers_public.phone_numbers
FOR INSERT
TO authenticated
WITH CHECK (
