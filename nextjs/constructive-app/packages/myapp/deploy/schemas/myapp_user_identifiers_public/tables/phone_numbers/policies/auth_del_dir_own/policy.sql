-- Deploy: schemas/myapp_user_identifiers_public/tables/phone_numbers/policies/auth_del_dir_own/policy
...
CREATE POLICY auth_del_dir_own ON myapp_user_identifiers_public.phone_numbers
FOR DELETE
TO authenticated
USING (
